  ...
  return (
    <div className="container px-4 mx-auto py-12">
      <div className="mb-8">
        <Link
          to="/blog"
          className="flex items-center text-primary hover:underline transition-all duration-200"
        >
      ...
      {post.coverImage && (
        <NorthernLights>
          <MovingBorder
            containerClassName="w-full mb-12 rounded-2xl overflow-hidden"
            className="p-0"
          >
            <div
              className={`w-full h-[300px] md:h-[400px] lg:h-[500px] ${post.coverImage} rounded-xl`}
            />
          </MovingBorder>
        </NorthernLights>
      )}
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 p-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4 max-w-2xl">
                {post.author} is a security researcher at Arjuna, specializing
                in Solana smart contract security with extensive experience
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            size="icon"
            className="rounded-full h-10 w-10 bg-secondary/40 hover:bg-primary/20 transition-colors"
          >
            <svg
