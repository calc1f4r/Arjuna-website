...
export const GridBackgroundDemo: React.FC<GridBackgroundDemoProps> = ({ 
  ...
  return (
    <div className={cn("h-full w-full bg-black relative flex flex-col items-center justify-center overflow-hidden rounded-md", className)}>
      ...
      <div className="absolute inset-0 w-full h-full z-10">
        ...
        <div className="absolute left-0 right-0 bottom-0 top-1/2 z-0 bg-gradient-to-t from-transparent to-accent/10" />
        <div className="absolute left-0 right-0 bottom-1/2 top-0 z-0 bg-gradient-to-b from-transparent to-primary/10" />
      </div>
